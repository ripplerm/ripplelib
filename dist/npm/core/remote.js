...
Remote.prototype.requestTx = Remote.prototype.requestTransaction = function (options, callback) {
...
Remote.prototype._accountRootRequest = function (command, filter, options, callback) {
...
Remote.prototype.requestAccountBalance = function (options, callback) {
  ...
  return this._accountRootRequest('account_balance', responseFilter, options, callback);
};
...
Remote.prototype.requestAccountFlags = function (options, callback) {
  ...
  return this._accountRootRequest('account_flags', responseFilter, options, callback);
};
...
Remote.prototype.requestOwnerCount = function (options, callback) {
  ...
  return this._accountRootRequest('owner_count', responseFilter, options, callback);
};
...
Remote.prototype.requestPathFindClose = function (callback) {
  ...
  request.callback(function (error, data) {
    _this._cur_path_find = null;
    if (_this._queued_path_finds.length > 0) {
      var pathfind = _this._queued_path_finds.shift();
      _this.createPathFind(pathfind.options, pathfind.callback);
    }
    if (callback) {
      callback(error, data);
    }
