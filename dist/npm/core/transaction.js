...
Transaction.prototype.sign = function (secret) {
  ...
  var keypair = deriveKeypair(secret || this._secret);
  this.tx_json.TxnSignature = sign(this.signingData().buffer, keypair.privateKey);
...
Transaction.prototype.multiSign = function (account, secret) {
  ...
  var keypair = deriveKeypair(secret);
